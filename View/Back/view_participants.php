...
<body>
    <header>
        <a href="admin.php" class="logo-area" style="border: none; background: none;">
            <span class="logo-text">NutriVert Admin</span>
        </a>
        <nav>
            <a href="admin.php?sub=events">Gestion Événements</a>
            <a href="admin.php?sub=categories">Gestion Catégories</a>
            <a href="admin.php?sub=participants" class="active">Gestion Participants</a>
            <a href="index.php" class="btn-primary-green">Voir Front Office</a>
        </nav>
    </header>
        ...
        <div class="glass-card">
            <div class="main-grid">
                <div class="form-side">
                    ...
                    <form action="admin.php?action=save_inscription" method="post" class="register-form" id="mainRegisterForm">
                        <div class="form-row">
    ...
    <script>
        ...
        window.deleteParticipant = (idx) => {
            ...
            if (confirm("Supprimer cette inscription ?")) {
                window.location.href = `admin.php?action=delete_participant&id=${p.id}`;
            }
        };
        ...
        window.handleFormDelete = () => {
            ...
            if (confirm("Voulez-vous vraiment supprimer ce participant ?")) {
                window.location.href = `admin.php?action=delete_participant&id=${id}`;
            }
        };
