...
<body>
    <header>
        ...
        <nav>
            <a href="admin.php?sub=events" class="active">Gestion Événements</a>
    ...
    <div class="container">
        ...
        <div class="builder-grid">
            <div class="form-box glass-card" style="grid-column: span 2; max-width: 800px; margin: 0 auto; width: 100%;">
                ...
                <form id="offerForm" action="admin.php?action=save_event" method="post">
        ...
        <!-- Offres en bas -->
        <h2 class="section-title"><i class="fas fa-calendar-alt"></i> Gestion des Événements</h2>
    ...
    <script>
        ...
        window.deleteOffer = (id) => {
            if (confirm("Voulez-vous vraiment supprimer cet événement ?")) {
                window.location.href = `admin.php?action=delete_event&id=${id}`;
            }
        };
