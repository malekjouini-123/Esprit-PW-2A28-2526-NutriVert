...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="admin.php?sub=categories" class="active">Gestion Catégories</a>
            <a href="admin.php?sub=participants">Gestion Participants</a>
    ...
    <div class="container">
        <div class="builder-grid">
            ...
            <div class="form-box">
                ...
                <form id="catForm" action="admin.php?action=save_category" method="post">
        ...
        <h2 class="section-title"><i class="fas fa-th-large"></i> Gestion des Catégories</h2>
    ...
    <script>
        ...
        window.deleteCat = (id) => {
            if (confirm("Voulez-vous vraiment supprimer cette catégorie ?")) {
                window.location.href = `admin.php?action=delete_category&id=${id}`;
            }
        };
