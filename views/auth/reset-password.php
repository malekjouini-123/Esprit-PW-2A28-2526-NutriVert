...
<head>
    ...
    <title>Réinitialisation du mot de passe — Nutrivert</title>
    ...
    <style>
        *{ margin:0; padding:0; box-sizing:border-box; }
        ...
        h2{ text-align:center; font-size:1.2rem; color:#4A6B4A; margin-bottom:22px; }
        .flash{
            background:#FFF0EE; border:1px solid #FF7E67; color:#c0392b;
            border-radius:16px; padding:10px 16px; font-size:.9rem;
            margin-bottom:18px; text-align:center;
        }
        label{ display:block; font-weight:600; color:#4A5B4A; margin-bottom:6px; font-size:.9rem; }
        input[type=password]{
            width:100%; padding:12px 18px; border:2px solid #E8F0E8;
            border-radius:40px; font-family:inherit; font-size:1rem;
            outline:none; transition:.2s; margin-bottom:18px;
        }
...
<div class="card">
    ...
    <form method="POST" action="index.php?view=reset-password&token=<?= htmlspecialchars($token ?? '') ?>">
        ...
        <button type="submit" class="btn"><i class="fas fa-check"></i> Réinitialiser</button>
    </form>

    <div class="back">
        <a href="index.php?view=login"><i class="fas fa-arrow-left"></i> Retour à la connexion</a>
    </div>
</div>
</body>
</html>
