...
<div class="wrap">
    <div class="card">
        ...
        <form method="post" enctype="multipart/form-data" action="index.php?controller=exercise&action=store">
            <div class="group">
            ...
            <div class="actions">
                ...
                <a href="index.php?controller=exercise&action=index<?= $currentCoachingId > 0 ? '&coaching_id=' . $currentCoachingId : '' ?>" class="btn btn-light">Back to Exercises</a>
            </div>
        </form>
    </div>
</div>
