...
<script>
    ...
    function completeCoaching() {
        ...
        const isFullCompletion = (currentIndex + 1 >= totalExercises);
        const quitParam = isFullCompletion ? '' : '&quit=1';
        window.location.href = 'index.php?controller=user_dashboard&action=complete' + quitParam;
    }
