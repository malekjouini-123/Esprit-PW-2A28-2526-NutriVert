...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input, textarea { width: 100%; border: 1px solid #cfd8d3; border-radius: 8px; padding: 0.62rem 0.7rem; font-size: 0.9rem; font-family: inherit; }
...
<div class="wrap">
    <div class="card">
        <h1>Edit Exercise - <?= $e($selectedProgram['title'] ?? ('Program #' . $coachingId)) ?></h1>
